...
class EventGridRecyclerAdapter(
    private var events: List<Event>,
    private val onEventClick: (String) -> Unit  // Lambda function for click callback
) : RecyclerView.Adapter<EventGridRecyclerAdapter.EventViewHolder>() {
    ...
    override fun onBindViewHolder(holder: EventViewHolder, position: Int) {
        ...
        // Set click listener to pass the eventID when the item is clicked
